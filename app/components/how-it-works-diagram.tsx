...
import { Search, Users, Mail, Calendar, ArrowRight, ChevronRight, ExternalLink } from "lucide-react"
    ...
    <section ref={containerRef} className="bg-white py-16 md:py-24 overflow-hidden">
      <div className="container mx-auto px-4 md:px-8">
          ...
          <div className="grid grid-cols-4 gap-6 relative">
            {steps.map((step, index) => (
              ...
              >
                ...
                {/* Step Card */}
                <div
                  className={`pt-12 pb-6 px-4 bg-white rounded-lg border ${activeStep === step.id ? "border-[#1e56a0]" : "border-gray-200"} shadow-md transition-all duration-300 ${activeStep === step.id ? "shadow-lg -translate-y-2" : ""}`}
                >
            ...
            {steps.map((step, index) => (
              ...
              >
                ...
                <details className="group">
                  <summary className="flex items-center cursor-pointer text-[#1e56a0] font-medium">
        ...
        >
          <Link
            href="/how-it-works"
            className="inline-flex items-center px-6 py-2 rounded-lg border border-[#1e56a0] text-[#1e56a0] font-medium hover:bg-[#1e56a0]/5 transition-colors duration-200 mr-4"
          >
            Learn More
